...
$upload_dir = '/uploads/articles/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../uploads/articles/'; // relative path from filemanager folder to upload folder (with final /)
